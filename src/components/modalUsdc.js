            ...
            <div className="relative w-auto my-6 mx-auto sm:max-w-3xl flex flex-row justify-center">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col bg-[#231a4f] outline-none focus:outline-none  w-[80%]">
                ...
                <div className="flex items-center justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-3xl font-semibold">USDC</h3>
                  <span
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-lg leading-relaxed">
                    Justus, an innovative blockchain platform aiming to
                    revolutionize decentralized finance, has recently unveiled
                    its plans to incentivize users by offering USDC, a prominent
                    stablecoin in the cryptocurrency market, for staking Justus
                    tokens during its introductory phase. This strategic
                    approach is geared towards encouraging early adoption and
                    fostering active engagement within the Justus community,
                    creating a robust and participatory user base. By providing
                    users with the opportunity to earn USDC through staking
                    Justus tokens, the platform seeks to not only expand its
                    user base but also emphasize the versatility and value of
                    USDC and the Justus token within the dynamic landscape of
